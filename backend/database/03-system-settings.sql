...
-- Adicionar coluna de categoria/permissão na tabela users
ALTER TABLE users ADD COLUMN admin_category VARCHAR(50) DEFAULT NULL;
...
-- Tabela de serviços para página de status
...
-- Inserir serviços padrão para a página de status
INSERT INTO status_services (name, category, status, location) VALUES
