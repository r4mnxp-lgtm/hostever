-- EXECUTAR ESTA MIGRAÇÃO URGENTEMENTE NO BANCO DE DADOS

-- 1. Verificar se as colunas existem
SELECT COLUMN_NAME 
FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_NAME = 'users' 
AND COLUMN_NAME IN ('email_verified', 'email_verification_token', 'email_verification_expires', 'admin_category', 'permissions');
...
-- 3. Marcar admins existentes como verificados
...
-- 6. Criar/atualizar tabela status_services
