...
export function Toaster() {
  ...
  // Garantir que toasts é sempre um array
  const safeToasts = Array.isArray(toasts) ? toasts : []

  return (
    <div className="fixed top-0 z-[9999] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]">
